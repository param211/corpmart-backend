...
urlpatterns = [
    ...
    path('api/v1/max-price', views.MaxSellingPriceView.as_view(), name="max-price"),
    path('api/v1/max-price', views.MaxAuthCapitalView.as_view(), name="max-price"),
    path('api/v1/max-price', views.MaxPaidupCapitalView.as_view(), name="max-price"),
