...
urlpatterns = [
    ...
    path('api/v1/max-sellingprice', views.MaxSellingPriceView.as_view(), name="max-sellingprice"),
    path('api/v1/max-authcapital', views.MaxAuthCapitalView.as_view(), name="max-authcapital"),
    path('api/v1/max-paidupcapital', views.MaxPaidupCapitalView.as_view(), name="max-paidupcapital"),
